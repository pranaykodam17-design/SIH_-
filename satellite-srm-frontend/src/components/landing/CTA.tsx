...
export const CTA: React.FC = () => {
  return (
    <section className="relative py-28 bg-white border-t border-[#D7E6F4] overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="relative rounded-3xl bg-gradient-to-b from-white/[0.08] via-white/[0.04] to-cyan-500/[0.04] border border-cyan-400/30 p-8 sm:p-14 text-center backdrop-blur-2xl shadow-[0_0_80px_rgba(0,212,255,0.12)] overflow-hidden">
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#1677FF]/20 border border-cyan-400/30 mb-6 shadow-[0_0_20px_rgba(0,212,255,0.2)]">
            <Sparkles size={14} className="text-cyan-700" />
            <span className="font-mono text-xs font-semibold tracking-wider text-cyan-800 uppercase">
              EXPERIENCE THE LIVE PIPELINE
            </span>
          </div>

          {/* Headline */}
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#10233F] tracking-tight mb-6 max-w-3xl mx-auto leading-tight">
          ...
          <p className="text-base sm:text-lg text-[#425873] max-w-2xl mx-auto mb-10 leading-relaxed font-normal">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-10">
            <Link
              to="/platform"
              className="group inline-flex items-center gap-2.5 px-8 py-4 rounded-xl bg-gradient-to-r from-cyan-400 via-blue-500 to-cyan-400 bg-[length:200%_auto] hover:bg-right text-[#10233F] font-black text-base shadow-[0_0_35px_rgba(0,212,255,0.5)] hover:shadow-[0_0_50px_rgba(0,212,255,0.8)] transition-all duration-300 transform hover:-translate-y-0.5"
            >
            ...
            <Link
              to="/gallery"
              className="inline-flex items-center gap-2 px-6 py-4 rounded-xl bg-white hover:bg-white text-[#425873] hover:text-[#10233F] font-semibold text-base border border-[#D7E6F4] hover:border-[#D7E6F4] backdrop-blur-md transition-all duration-200"
            >
          ...
          {/* Feature Badges */}
          <div className="pt-8 border-t border-[#D7E6F4] flex flex-wrap items-center justify-center gap-6 sm:gap-10 text-xs sm:text-sm text-[#526A82]">
            ...
            <div className="flex items-center gap-2">
              <Satellite size={16} className="text-[#1677FF]" />
