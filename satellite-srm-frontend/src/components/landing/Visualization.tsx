...
export const Visualization: React.FC = () => {
  return (
    ...
    >
      ...
      <div className="absolute bottom-10 right-1/4 w-[500px] h-[500px] rounded-full bg-blue-600/[0.05] blur-[130px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <div className="inline-flex items-center gap-2 sm:gap-3 px-4 py-2 rounded-2xl bg-white/[0.04] border border-cyan-400/30 backdrop-blur-md shadow-[0_0_25px_rgba(0,212,255,0.15)]">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 relative rounded-3xl bg-gradient-to-b from-white/[0.05] to-white/[0.02] border border-cyan-500/25 p-4 sm:p-6 backdrop-blur-2xl shadow-[0_0_50px_rgba(0,212,255,0.08)] overflow-hidden">
            <div className="flex items-center justify-between px-4 py-2 mb-2 border-b border-white/[0.08]">
            ...
            <div className="px-4 py-2 mt-2 bg-black/40 rounded-xl border border-white/10 flex items-center justify-between text-xs text-slate-400">
              <span className="font-mono">Axial Tilt: 23.4°</span>
              <span className="font-mono text-cyan-400">GLB Drop-In: Active</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 space-y-4">
            {/* Pillar 1: Blender */}
            <div className="rounded-2xl bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.08] hover:border-cyan-500/30 p-6 backdrop-blur-md transition-all duration-300">
              <div className="flex items-center gap-3.5 mb-3">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white">Blender 3D Modeling</h3>
                  <p className="text-xs font-mono text-slate-400">Digital Terrain & Asset Authoring</p>
                </div>
              </div>
            ...
            <div className="rounded-2xl bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.08] hover:border-cyan-500/30 p-6 backdrop-blur-md transition-all duration-300">
              <div className="flex items-center gap-3.5 mb-3">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white">WebGL & Three.js</h3>
                  <p className="text-xs font-mono text-slate-400">Hardware-Accelerated In-Browser Engine</p>
                </div>
              </div>
              <p className="text-xs text-slate-300 leading-relaxed">
            ...
            <div className="rounded-2xl bg-white/[0.03] hover:bg-white/[0.06] border border-white/[0.08] hover:border-cyan-500/30 p-6 backdrop-blur-md transition-all duration-300">
              <div className="flex items-center gap-3.5 mb-3">
                <div className="w-10 h-10 rounded-xl bg-blue-500/15 border border-blue-400/30 flex items-center justify-center text-blue-300">
                  <Code2 size={20} />
                </div>
                <div>
                  <h3 className="text-lg font-bold text-white">React Three Fiber</h3>
                  <p className="text-xs font-mono text-slate-400">Declarative 3D Architecture</p>
                </div>
              </div>
              <p className="text-xs text-slate-300 leading-relaxed">
